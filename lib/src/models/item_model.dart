...
//
//     final ItemModel = movieFromJson(jsonString);

import 'dart:convert';

ItemModel movieFromJson(String str) => ItemModel.fromJson(json.decode(str));

String movieToJson(ItemModel data) => json.encode(data.toJson());
